...
export type SubmitDonationApplicationInput = z.infer<typeof submitDonationApplicationSchema>;

// Schema for getting donation history with filters
export const getDonationHistorySchema = z.object({
  status: z.enum(['pending', 'completed', 'cancelled', 'all']).optional().default('all'),
  page: z
    .string()
...
export type GetDonationProjectsInput = z.infer<typeof getDonationProjectsSchema>;
